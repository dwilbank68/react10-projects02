...
import RepoListComponent from './RepoList.jsx'
                ...
                <div className="panel-body">
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            ...
                            <br/>
                            <a href={this.props.userData.html_url} target="_blank" className="btn btn-primary">
                                Visit Profile
                            </a>
                        </div>
                    </div>
                    ...
                    <RepoListComponent userRepos={this.props.userRepos}/>
